...
public:
    ...
    void on_enter(fsm::Blackboard &blackboard) override {
        ...
        goal_ = Eigen::Vector3d({home_pos_.x(), home_pos_.y(), home_pos_.z() + takeoff_height});
    ...
    std::string act(fsm::Blackboard &blackboard) override {
        ...
        if (!over_base_){
            ...
            drone_->setLocalPosition(little_goal_[0], little_goal_[1], little_goal_[2], orientation[2]);
        }
        else
        {
            ...
            little_goal_ = goal_diff + pos_;
            drone_->setLocalPosition(little_goal_[0], little_goal_[1], little_goal_[2] - 0.05, orientation[2]);
        }
...
private:
    ...
    Eigen::Vector3d home_pos_, pos_, home_horizon_, goal_, goal_diff, little_goal_, orientation;
    Drone* drone_;
